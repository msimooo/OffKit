/* ═══════════════════════════════════════════════════════════════
   ...
   · Blank iframe on return     → improved fetch handler with better
     error handling and cache fallback chaining for all HTML requests
   · Iframe switching issue     → proper cache matching for all GET
     requests even when offline
═══════════════════════════════════════════════════════════════ */

const CACHE_NAME = 'my-apps-v4';
